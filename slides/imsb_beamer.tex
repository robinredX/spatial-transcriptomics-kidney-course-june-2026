...
\setbeamertemplate{title page}{%
  ...
  \vskip0.4em
  {\color{imsbgrey}\insertinstitute\par}
  \vskip1.4em
  {\insertdate\par}
}
...
\tikzset{
  ...
  lab/.style={align=center,font=\scriptsize,text=imsbgrey},
  arr/.style={-{Stealth[length=2.4mm]},thick,draw=imsbdark},
  line/.style={thick,draw=imsbblue},
}
\newcommand{\refline}[1]{\vfill{\scriptsize\color{imsbgrey} #1}}
\newcommand{\figslot}[2]{%
  \begin{center}
  ...
  {\scriptsize\color{imsbgrey} suggested source: #2}}}
  \end{center}}